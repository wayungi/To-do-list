...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui */ \"./src/ui.js\");\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ui__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nconst form = document.querySelector('.todo-form');\nconst input = document.querySelector('.add-item');\nconst toDosList = document.querySelector('.todos');\nconst allCompleted = document.querySelector('#remove-completed-tasks');\nconst refresh = document.querySelector('.fa-rotate');\n\n// on form submit\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const inputValue = input.value;\n  if (inputValue) {\n    input.value = '';\n    const activity = { description: inputValue, completed: false, index: (0,_ui__WEBPACK_IMPORTED_MODULE_1__.arrayLength)() + 1 };\n    const toDoTaskElement =  (0,_ui__WEBPACK_IMPORTED_MODULE_1__.toDoTask)();\n    const hiddenInputEle = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.hiddenInputElement)(activity.index);\n    const checkbox = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createCheckBox)(activity.completed);\n    const inputElement = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createTextInput)(activity.description);\n    const optionsElement = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createOptions)();\n    // create object conatining dom elements for the doto activity\n    const elemObj = {\n      toDoTaskElement,\n      hiddenInputEle,\n      checkbox,\n      inputElement,\n      optionsElement,\n      toDosList\n    }; \n    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.addTaskToToDosList)(elemObj);\n    const updatedArray = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.updateTasks)(activity);\n    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.updateLocalStorage)(updatedArray);\n  };\n});\n\ndocument.addEventListener('DOMContentLoaded', () => {\n  //check local storage and add its elements to our tasks array & return the tasks array\n  const tasks = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.populateTasks)();\n  if (tasks.length < 1) return;\n  tasks.forEach((task) => {\n    const toDoTaskElement =  (0,_ui__WEBPACK_IMPORTED_MODULE_1__.toDoTask)();\n    const hiddenInputEle = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.hiddenInputElement)(task.index);\n    const checkbox = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createCheckBox)(task.completed);\n    const inputElement = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createTextInput)(task.description);\n    const optionsElement = (0,_ui__WEBPACK_IMPORTED_MODULE_1__.createOptions)();\n    // create object conatining dom elements for the doto activity\n    const elemObj = {\n      toDoTaskElement,\n      hiddenInputEle,\n      checkbox,\n      inputElement,\n      optionsElement,\n      toDosList\n    }; \n    (0,_ui__WEBPACK_IMPORTED_MODULE_1__.addTaskToToDosList)(elemObj);\n  });\n});\n\n\n\nallCompleted.addEventListener('click', () => {\n  (0,_ui__WEBPACK_IMPORTED_MODULE_1__.removeAllChecked)();\n});\n\nrefresh.addEventListener('click', () => {\n  (0,_ui__WEBPACK_IMPORTED_MODULE_1__.removeAllChecked)();\n});\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
